...
<html  lang="en">
<!--#######################################
#*This is the actual page that people will be able to see their password and other data from the register page 
#*they will be able to got to the loggin page to log on to see the playladder.php
#-#######################################-->
   <head>
  ...
  <body  style="height:1650px;background:#ddf3f6 url('wpimages/wp48090e4b_06.png') repeat-x scroll center top;background-size:auto;">
    ...
    <div  id="divMain"  style="background:transparent;margin-left:auto;margin-right:auto;position:relative;width:960px;height:1650px;">
      ...
      <div style="position:absolute;left:75px;top:216px;width:300px;height:auto;overflow:show;">
            <div class="underwater" style="text-align:center;position:absolute;top:300px;width:800px;height:40px;overflow:show;left:150px;">
            <pclass="Heading-1 P-4"><span  class="C-5">Here is what you have entered into the system</span></p></div>';
          '<a  value="Redirect Me" style="display:block;position:absolute; left:172px; top:360px; width:150px; height:42px;"  class="button" href="/loggin.php">Redirect Me</a>';
    <div style="position:absolute;left:200px;top:390px;width:500px;height:300px;overflow:show;">
 <?php require  'wpscripts/add.php';  ?>
