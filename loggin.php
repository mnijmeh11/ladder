...
<div style="position: absolute; top:50px; left:4px; width:auto;"> 
    <div class="underwater" style="position: absolute; top: 460px; width:450px; height: 40px; left: 270px;"><class="Heading-1 P-4"><span  class="C-5">  Log on to the Ladder Game</span></div>      
<div id="login" style="position:absolute;top:522px; left: 79px; width: 900px;">
...
<input class="mytext" name="submit" type="text" value="<?php echo $error; ?>" readonly/>
        ...
        <div id="vibrate" style="width:600px;position:absolute; top:580px;left:300px;"> 
<h1><span>Play Nice</span>Enjoy <span>Your Game</span>!</h1></div>   
