...
<html  lang="en">
<!--#######################################
#*This is the actual page that people will be able to see their dates for a challenge and other data from the playladder page 
#-#######################################-->
   <head>
...
line-height:42px;
 ...
 <?php require  'wpscripts/acceptachallenge.php';  ?>
