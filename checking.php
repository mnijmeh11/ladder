...
<html  lang="en">
  <head>
    ...
    <link  rel="stylesheet"  type="text/css"  href="wpscripts/Myform.css">
...
line-height:42px;
  ...
  <body  style="height:1650px;background:#ddf3f6 url('wpimages/wp48090e4b_06.png') repeat-x scroll center top;background-size:auto;">
    ...
    <div  id="divMain"  style="background:transparent;margin-left:auto;margin-right:auto;position:relative;width:960px;height:1650px;">
      ...
      <img  alt="MosesÂ’ Ladder Game"  src="wpimages/wp4a650d0c_06.png"  style="position:absolute;left:77px;top:32px;width:283px;height:79px;">
      ...
      <div  id="slider_1"  style="position:absolute;left:55px;top:184px;width:850px;height:284px;overflow:hidden;">
        <div  id="slider_1_P1"  style="position:absolute;left:0px;right:0px;width:850px;height:284px;">
          <img  alt=""  src="wpimages/wp121bd566_05_06.jpg"  style="position:absolute;left:0px;top:0px;width:850px;height:284px;">
        </div>
        <div  id="slider_1_P2"  style="position:absolute;left:0px;right:0px;width:850px;height:284px;visibility:hidden;display:none;">
          <img  alt=""  src="wpimages/wp4edc98b1_05_06.jpg"  style="position:absolute;left:0px;top:0px;width:850px;height:284px;">
        </div>
        <div  id="slider_1_P3"  style="position:absolute;left:0px;right:0px;width:850px;height:284px;visibility:hidden;display:none;">
          <img  alt=""  src="wpimages/sports3.jpg"  style="position:absolute;left:0px;top:0px;width:850px;height:284px;">
        </div>
        <div  id="slider_1_P3"  style="position:absolute;left:0px;right:0px;width:850px;height:284px;visibility:hidden;display:none;">
          <img  alt=""  src="wpimages/sports2.jpg"  style="position:absolute;left:0px;top:0px;width:850px;height:284px;">
        </div>
        <div  id="slider_1_P3"  style="position:absolute;left:0px;right:0px;width:850px;height:284px;visibility:hidden;display:none;">
          <img  alt=""  src="wpimages/sports1.jpg"  style="position:absolute;left:0px;top:0px;width:850px;height:284px;">
        </div>
        <div  id="slider_1_P3"  style="position:absolute;left:0px;right:0px;width:850px;height:284px;visibility:hidden;display:none;">
          <img  alt=""  src="wpimages/sports4.jpg"  style="position:absolute;left:0px;top:0px;width:850px;height:284px;">
        </div>
        <div  id="slider_1_P3"  style="position:absolute;left:0px;right:0px;width:850px;height:284px;visibility:hidden;display:none;">
          <img  alt=""  src="wpimages/sports5.jpg"  style="position:absolute;left:0px;top:0px;width:850px;height:284px;">
        </div>
        <div  id="slider_1_P3"  style="position:absolute;left:0px;right:0px;width:850px;height:284px;visibility:hidden;display:none;">
          <img  alt=""  src="wpimages/sports6.jpg"  style="position:absolute;left:0px;top:0px;width:850px;height:284px;">
        </div>
      </div>
      ...
      <div  style="position:absolute;left:353px;top:33px;width:600px;height:79px;">
        ...
        <!--here is my index.html link--> <a  href="index.html"  id="nav_12_B1"
        ...
        <!--here is my loggin html link --> <a  href="loggin.html"  id="nav_12_B2" class="OBJ-1 ActiveButton OBJ-2"  style="display:block;position:absolute;left:380px;top:18px;width:103px;height:42px;">
          <span>Log&nbsp;Inn</span></a>
        <!--here is my register html link --> <a  href="register.html"  id="nav_12_B2" class="OBJ-1 ActiveButton OBJ-2"  style="display:block;position:absolute;left:478px;top:18px;width:103px;height:42px;">
      ...
      <div  id="txt_20"  style="position:absolute;left:50px;top:1491px;width:205px;height:122px;overflow:hidden;">
        ...
        <p  class="Normal P-3"><a  href="loggin.html"  class="C-3">Log&nbsp;In</a></p>
        <p  class="Normal P-3"><a  href="register.html"  class="C-3">Register </a></p>
...
<?php
    ...
    try {
        ...
        if($rows->rowCount() > 0) 
        {   
            echo '<div class="underwater" style="text-align:center;position:absolute;top:490px;width:300px;height:40px;overflow:show;left:40px;">
            <pclass="Heading-1 P-4"><span  class="C-5">Top Players</span></p></div>';
            echo '<table  class="MyUpdate" style="position: absolute;top:540px;width:auto; height:auto;overflow:show;left:57px;">';
            echo '<tbody>';
...
<?php
    ...
    try {
        ...
        if($rows->rowCount() > 0) 
        {   
            echo '<div class="underwater" style="text-align:center;position:absolute;top:490px;width:auto;height:40px;overflow:show;left:400px;">
            <pclass="Heading-1 P-4"><span  class="C-5">Current Challenges</span></p></div>';
            echo '<table  class="MyUpdate" style="position: absolute;top:540px;width:auto; height:auto;overflow:show;left:357px;">';
            echo '<tbody>';
            echo '<tr>'.'<th>challenger</th>'.'<th>challengee</th>'.'<th>issued</th>'. '<th>accepted</th>'. '<th>scheduled</th>'.'</tr>';
            foreach($rows as $row)
            {
...
?>
    ...
    try {
        ...
        if($rows->rowCount() > 0) 
        {   
            echo '<div class="underwater" style="text-align:center;position:absolute;top:980px;width:300px;height:40px;overflow:show;left:40px;">
            <pclass="Heading-1 P-4"><span  class="C-5">Game Totals</span></p></div>';
            echo '<table  class="MyUpdate" style="position: absolute;top:1050px;width:auto; height:auto;overflow:show;left:57px;">';
            echo '<tbody>';
            echo '<th>Rank</th>'.'<th>Name</th>'.'<th>User Name</th>';
            foreach($rows as $row)
            {
...
?>
          ...
          <div> </div>
          <!--end of the body as long as you keep the format-->
          <!--Here is the making of the images for the buttom of the page--> 
          <img  alt=""  src="wpimages/wpfb491e60_06.png"  style="position:absolute;left:15px;top:240px;width:100%;height:11px;">
